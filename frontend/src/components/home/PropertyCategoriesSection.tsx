...
const CATEGORIES = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1500382017468-90403fed87ef?auto=format&fit=crop&w=800&q=80",
  },
  {
            ...
            >
              ...
              >
                ...
                <div className="p-4 flex items-center justify-between gap-2">
                  <p className="text-xs text-slate-600 dark:text-slate-300 line-clamp-2">{cat.description}</p>
