  ...
  return (
    <section className="py-20 lg:py-28 section-padding bg-accent/50">
      <div className="container mx-auto px-4">
        <SectionHeading subtitle="Building Materials" title="Quality Supplies" align="center" />
        ...
        <div className="text-center mt-12">
          <Button asChild size="lg">
            <Link href="/materials">Browse Materials <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      </div>
    </section>
